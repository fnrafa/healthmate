                    ...
                    <div class="card">
                        <div class="card-body row">
                            <div class="col-10">
                                ...
                                <p class="text-secondary">
                                    <span class="text-dark">Patient : </span>{{(isset($consult->patient->name))? $consult->patient->name :''}}
                                </p>
                                <p class="text-secondary">
                            ...
                            <div class="col-12">
                                <button class="btn btn-outline-success"
                                        onclick="updateConsultationStatus('{{ $consult->id }}', 'completed')">Mark As
                                    Done
                                </button>
                                <button class="btn btn-outline-warning"
                                        onclick="updateConsultationStatus('{{ $consult->id }}', 'referred')">Make a
                                    Referral
                                </button>
                            </div>
                        </div>
                                    ...
                                    @foreach($messages as $message)
                                        <div id="message-{{$message->id}}"
                                            ...
                                            @if(isset($message->media))
                                                <div><img src="{{ $message->media }}" class="img-fluid" alt="Uploaded Image"></div>
                                            @endif
